...
extension Candidate {
    static let federalLocality = PoliticalLocality(id: 1, geo_json_id: nil, created: Date(), updated: Date(), name: "United States", type: PoliticalLocalityType.federal)
